    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(allow_unicode=True, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('mainskills', models.ManyToManyField(related_name='positions_main', to='accounts.MainSkill')),
                ('otherskills', models.ManyToManyField(related_name='positions_other', to='accounts.OtherSkill')),
